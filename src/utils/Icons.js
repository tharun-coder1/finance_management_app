...
export const trend = <i class="fa-solid fa-money-bills"></i>
...
export const burger = <i className="fa-solid fa-utensils"></i>
...
export const deficon = <i class="fa-solid fa-money-bill-1"></i>